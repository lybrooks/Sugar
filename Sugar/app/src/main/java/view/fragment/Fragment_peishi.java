 ...
 */
public class Fragment_peishi extends Fragment {
    ...
    public Fragment_peishi() {
        // Required empty public constructor
    }

    public Fragment_peishi(int id) {
        this.id = id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_peishi, container, false);
