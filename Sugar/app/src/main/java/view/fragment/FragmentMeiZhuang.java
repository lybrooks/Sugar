...
public class FragmentMeiZhuang extends Fragment {
    ...
    public FragmentMeiZhuang() {
    }

    public FragmentMeiZhuang(int id) {
        this.id = id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_mei_zhuang, container, false);
